...
Revision ID: b3e7acb6e391
Revises:
Create Date: 2025-05-14 16:40:46.392491
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_blacklistedtoken_access_token"),
        "blacklistedtoken",
        ["access_token"],
        unique=True,
    )
    op.create_index(
        op.f("ix_blacklistedtoken_refresh_token"),
        "blacklistedtoken",
        ["refresh_token"],
        unique=True,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_blacklistedtoken_refresh_token"), table_name="blacklistedtoken"
    )
    op.drop_index(
        op.f("ix_blacklistedtoken_access_token"), table_name="blacklistedtoken"
    )
